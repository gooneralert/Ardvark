...
void ExampleFrame(int screen_w, int screen_h) {
    ...
    if (mode == 0) {
        ...
        dl->AddImageRounded(reinterpret_cast<ImTextureID>(static_cast<intptr_t>(gBlur.tex)), rect.Min, rect.Max,
        ...
        dl->AddImageRounded(reinterpret_cast<ImTextureID>(static_cast<intptr_t>(gBlur.tex)), pos, ImVec2(pos.x + size.x, pos.y + size.y),
                            ImVec2(0.0f, 1.0f), ImVec2(1.0f, 0.0f),
                            IM_COL32(255, 255, 255, 255), corner, ImDrawFlags_RoundCornersAll);
        ...
        dl->AddImageRounded(reinterpret_cast<ImTextureID>(static_cast<intptr_t>(gBlur.tex)), ImVec2((float)x, (float)y), ImVec2((float)(x + w), (float)(y + h)),
                            ImVec2(0.0f, 1.0f), ImVec2(1.0f, 0.0f),
                            IM_COL32(255, 255, 255, 255), corner, ImDrawFlags_RoundCornersAll);
