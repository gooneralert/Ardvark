...
// Primary source:   https://dumper.jonah.cool/version-ddf602d9cfe44005/offsets.h
// Secondary source: https://offsets.imtheo.lol/offsets.hpp
...
namespace FakeDataModel {
    constexpr uintptr_t Pointer = 0x8B79B58;
...
namespace Functions {
    constexpr uintptr_t Clone = 0x880E00;
    constexpr uintptr_t Destroy = 0x880E20;
    constexpr uintptr_t FindPartOnRay = 0x25098C0;
    constexpr uintptr_t FindPartOnRayWithIgnoreList = 0x2509940;
    constexpr uintptr_t FindPartOnRayWithWhitelist = 0x25099D0;
    constexpr uintptr_t FireServer = 0x21502A0;
    constexpr uintptr_t Print = 0x92C340;
    constexpr uintptr_t RaisePropertyChanged = 0x8C5C30;
    constexpr uintptr_t Raycast = 0x2500AA0;
    constexpr uintptr_t SetParent = 0x8C6380;
    constexpr uintptr_t SetParentInternal = 0x8C57A0;
    constexpr uintptr_t Shapecast = 0x2502430;
}
...
namespace ScriptContext {
    constexpr uintptr_t RequireBypass = 0x898;
}
...
namespace TaskScheduler {
    ...
    constexpr uintptr_t Pointer = 0x88B64C8;
}
...
namespace TextButton {
    ...
    constexpr uintptr_t Font = 0x1140;
...
namespace TextLabel {
    ...
    constexpr uintptr_t Font = 0xEC0;
...
namespace Types {
    constexpr uintptr_t AllTypes = 0x86AD1F8;
}
...
namespace VisualEngine {
    ...
    constexpr uintptr_t Pointer = 0x8136228;
...
namespace Workspace {
    ...
    constexpr uintptr_t ReadOnlyGravity = 0x9C0;
...
namespace SurfaceAppearance {
    constexpr uintptr_t AlphaMode = 0x290;
    constexpr uintptr_t Color = 0x278;
    constexpr uintptr_t ColorMap = 0xc8;
    constexpr uintptr_t EmissiveMaskContent = 0xf8;
    constexpr uintptr_t EmissiveStrength = 0x294;
    constexpr uintptr_t EmissiveTint = 0x284;
