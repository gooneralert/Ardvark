...
// Secondary source (Jonah): https://dumper.jonah.cool/version-4310300497aa4917/offsets.h
...
namespace Animator {
    constexpr uintptr_t ActiveAnimations = 0xab0;
}
...
namespace BasePart {
    ...
    constexpr uintptr_t Shape = 0x1b8;
...
namespace DataModel {
    ...
    constexpr uintptr_t GameLoaded = 0x5e0;
    constexpr uintptr_t JobId = 0x120;
    constexpr uintptr_t PlaceId = 0x198;
    constexpr uintptr_t PlaceVersion = 0x1b4;
    constexpr uintptr_t PrimitiveCount = 0x428;
    constexpr uintptr_t ScriptContext = 0x440;
    constexpr uintptr_t ServerIP = 0x5c8;
    constexpr uintptr_t ToRenderView1 = 0x1d0;
...
namespace FakeDataModel {
    constexpr uintptr_t Pointer = 0x8e42c98;
    constexpr uintptr_t RealDataModel = 0x1f8;
}

namespace FileMeshData {
    constexpr uintptr_t AABBMax = 0x18c;
    constexpr uintptr_t AABBMin = 0x180;
...
namespace GuiObject {
    ...
    constexpr uintptr_t SelectionOrder = 0x598;
...
namespace Humanoid {
    ...
    constexpr uintptr_t BreakJointsOnDeath = 0xc5;
    ...
    constexpr uintptr_t HumanoidRootPart = 0x470;
    constexpr uintptr_t HumanoidState = 0x8b8;
    constexpr uintptr_t HumanoidStateID = 0x20;
    constexpr uintptr_t IsWalking = 0x95f;
    ...
    constexpr uintptr_t WalkTimer = 0x400;
    constexpr uintptr_t Walkspeed = 0x1d0;
    constexpr uintptr_t WalkspeedCheck = 0x3b4;
...
namespace Primitive {
    constexpr uintptr_t AssemblyAngularVelocity = 0xec;
    constexpr uintptr_t AssemblyLinearVelocity = 0xe0;
    constexpr uintptr_t Flags = 0x1be;
    constexpr uintptr_t Material = 0x0;
    constexpr uintptr_t Owner = 0x218;
    constexpr uintptr_t Position = 0xd4;
    constexpr uintptr_t Rotation = 0xb0;
    constexpr uintptr_t Size = 0x1c4;
...
namespace Seat {
    constexpr uintptr_t Occupant = 0x218;
}
...
namespace SpawnLocation {
    ...
    constexpr uintptr_t TeamColor = 0x1ec;
}
...
namespace StatsItem {
    constexpr uintptr_t Value = 0xd66a;
}
...
namespace TaskScheduler {
    ...
    constexpr uintptr_t Pointer = 0x8bdd8e8;
}
...
namespace Terrain {
    constexpr uintptr_t GrassLength = 0x1f0;
    constexpr uintptr_t MaterialColors = 0x4b8;
    constexpr uintptr_t WaterColor = 0x1e0;
    constexpr uintptr_t WaterReflectance = 0x1f8;
    constexpr uintptr_t WaterTransparency = 0x1fc;
    constexpr uintptr_t WaterWaveSize = 0x200;
    constexpr uintptr_t WaterWaveSpeed = 0x204;
}

namespace Textures {
    constexpr uintptr_t Decal_Texture = 0x1e0;
    constexpr uintptr_t Texture_Texture = 0x1e0;
}

namespace Tool {
    constexpr uintptr_t CanBeDropped = 0x4b8;
    constexpr uintptr_t Enabled = 0x475;
    constexpr uintptr_t Grip = 0x4ac;
    constexpr uintptr_t ManualActivationOnly = 0x295;
...
namespace VisualEngine {
    constexpr uintptr_t Dimensions = 0xb10;
    constexpr uintptr_t FakeDataModel = 0xaf0;
    constexpr uintptr_t Pointer = 0x846f768;
    constexpr uintptr_t RenderView = 0xc30;
    constexpr uintptr_t ViewMatrix = 0x1b0;
}
...
namespace Workspace {
    constexpr uintptr_t CurrentCamera = 0x4b8;
    constexpr uintptr_t DistributedGameTime = 0x4d8;
    constexpr uintptr_t ReadOnlyGravity = 0xa00;
    constexpr uintptr_t World = 0x410;
}

namespace World {
    constexpr uintptr_t AirProperties = 0x240;
    constexpr uintptr_t FallenPartsDestroyHeight = 0x220;
    constexpr uintptr_t Gravity = 0x22c;
    constexpr uintptr_t Primitives = 0x2b0;
    constexpr uintptr_t worldStepsPerSec = 0x728;
