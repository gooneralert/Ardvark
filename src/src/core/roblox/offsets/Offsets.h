...
// Secondary source (Jonah): https://dumper.jonah.cool/version-c5aecda2245e4fae/offsets.h
...
namespace FakeDataModel {
    constexpr uintptr_t Pointer = 0x8dc2258;
...
namespace StatsItem {
    constexpr uintptr_t Value = 0x1091;
}
...
namespace TaskScheduler {
    ...
    constexpr uintptr_t Pointer = 0x8b5cee8;
}
...
namespace VisualEngine {
    ...
    constexpr uintptr_t Pointer = 0x83f0a08;
