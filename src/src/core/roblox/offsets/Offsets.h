...
// Primary source:   C:\Users\blake\Downloads\roblox-dumper-3.5\roblox-dumper\out\x64-release\offsets.h
// Secondary source: https://offsets.imtheo.lol/version-ce0bcd0fbd484804/offsets.hpp
...
namespace Btools {
    constexpr uintptr_t MouseCommandWorkspace = 0x50;
    constexpr uintptr_t ToolAllocationSize = 0x148;
    constexpr uintptr_t WorkspaceCurrentCommand = 0x878;
    constexpr uintptr_t WorkspaceCurrentRefCount = 0x880;
    constexpr uintptr_t WorkspaceStickyCommand = 0x888;
    constexpr uintptr_t WorkspaceStickyRefCount = 0x890;
}
...
namespace Creator {
    constexpr uintptr_t MapEnd = 0x82D7A68;
    constexpr uintptr_t MapStart = 0x82D7A60;
}

namespace DataModel {
    constexpr uintptr_t CreatorId = 0x178;
    constexpr uintptr_t GameId = 0x180;
    constexpr uintptr_t GameLoaded = 0x5C0;
    constexpr uintptr_t JobId = 0x118;
    constexpr uintptr_t PlaceId = 0x188;
    constexpr uintptr_t ServerIP = 0x5A8;
    constexpr uintptr_t Workspace = 0x158;
    constexpr uintptr_t PlaceVersion = 0x1a4;
    constexpr uintptr_t PrimitiveCount = 0x408;
    constexpr uintptr_t ScriptContext = 0x440;
    constexpr uintptr_t ToRenderView1 = 0x1c0;
...
namespace FakeDataModel {
    constexpr uintptr_t Pointer = 0x8C426F8;
    constexpr uintptr_t RealDataModel = 0x1D8;
}

namespace FastClusterEntity {
    constexpr uintptr_t AlphaByte = 0x14;
    constexpr uintptr_t BBoxMaxX = 0xA4;
    constexpr uintptr_t BBoxMaxY = 0xA8;
    constexpr uintptr_t BBoxMaxZ = 0xAC;
    constexpr uintptr_t BBoxMinX = 0x98;
    constexpr uintptr_t BBoxMinY = 0x9C;
    constexpr uintptr_t BBoxMinZ = 0xA0;
    constexpr uintptr_t ContextPtr = 0x8;
    constexpr uintptr_t DecalMaterialPtr = 0x48;
    constexpr uintptr_t MaterialPtr = 0x20;
    constexpr uintptr_t PrimitiveIndexArrayPtr = 0x80;
    constexpr uintptr_t RenderQueueAlwaysOnTop = 0xD;
    constexpr uintptr_t RenderQueueId = 0x10;
    constexpr uintptr_t TechniqueArrayPtr = 0x70;
    constexpr uintptr_t VTableRva = 0x6AE1C10;
}
...
namespace Fire {
    constexpr uintptr_t FireProximityPrompt = 0x30C3170;
}
...
namespace Functions {
    constexpr uintptr_t Clone = 0x15F8B80;
    constexpr uintptr_t Destroy = 0x15F8BA0;
    constexpr uintptr_t FindPartOnRay = 0xEA7BE0;
    constexpr uintptr_t FindPartOnRayWithIgnoreList = 0xEA7C60;
    constexpr uintptr_t FindPartOnRayWithWhitelist = 0xEA7CF0;
    constexpr uintptr_t FireServer = 0xC901C0;
    constexpr uintptr_t Print = 0x1C68F60;
    constexpr uintptr_t Raycast = 0xE9F200;
    constexpr uintptr_t SetParent = 0xB01080;
    constexpr uintptr_t SetParentInternal = 0x1BF64F0;
    constexpr uintptr_t Shapecast = 0xEA0BC0;
}
...
namespace GuiObject {
    ...
    constexpr uintptr_t Text = 0xdf8;
    constexpr uintptr_t TextColor3 = 0xea8;
}
...
namespace Humanoid {
    ...
    constexpr uintptr_t IsWalking = 0x93f;
...
namespace Lighting {
    ...
    constexpr uintptr_t ColorShift_Bottom = 0xDC;
    constexpr uintptr_t ColorShift_Top = 0xE8;
...
namespace MaterialLayer {
    constexpr uintptr_t ColorData = 0x24;
    constexpr uintptr_t FillModeByte = 0x11;
    constexpr uintptr_t Flags2 = 0x20;
    constexpr uintptr_t MatFlags = 0x18;
    constexpr uintptr_t Param = 0x1C;
    constexpr uintptr_t Stride = 0x88;
}
...
namespace MeshPart {
    constexpr uintptr_t MeshId = 0x308;
    constexpr uintptr_t TextureId = 0x338;
    constexpr uintptr_t Texture = 0x338;
}
...
namespace Player {
    ...
    constexpr uintptr_t LocaleId = 0x740;
...
namespace Primitive {
    ...
    constexpr uintptr_t Material = 0x246;
...
namespace ScriptContext {
    constexpr uintptr_t RequireBypass = 0x9A0;
}
...
namespace Sky {
    ...
    constexpr uintptr_t SunAngularSize = 0x24C;
...
namespace TaskScheduler {
    ...
    constexpr uintptr_t Pointer = 0x89DD108;
}
...
namespace TechniqueArray {
    constexpr uintptr_t BeginOffset = 0x0;
    constexpr uintptr_t EndOffset = 0x8;
    constexpr uintptr_t EntryStride = 0x88;
}

namespace Terrain {
    constexpr uintptr_t GrassLength = 0x1E8;
    constexpr uintptr_t MaterialColors = 0x490;
...
namespace Tool {
    ...
    constexpr uintptr_t Grip = 0x488;
...
namespace VisualEngine {
    ...
    constexpr uintptr_t Pointer = 0x827DD88;
...
namespace Workspace {
    ...
    constexpr uintptr_t World = 0x3F0;
    constexpr uintptr_t DistributedGameTime = 0x4b8;
}

namespace World {
    constexpr uintptr_t AirProperties = 0x220;
    constexpr uintptr_t Gravity = 0x210;
    constexpr uintptr_t Primitives = 0x290;
    constexpr uintptr_t WorldSteps = 0x708;
    constexpr uintptr_t FallenPartsDestroyHeight = 0x208;
    constexpr uintptr_t worldStepsPerSec = 0x708;
}

namespace AnimationTrack {
    constexpr uintptr_t Animation = 0xb8;
    constexpr uintptr_t Animator = 0x108;
    constexpr uintptr_t IsPlaying = 0xa50;
...
namespace Animator {
    constexpr uintptr_t ActiveAnimations = 0xb80;
}
...
namespace RunService {
    constexpr uintptr_t HeartbeatFPS = 0xc8;
...
namespace UnionOperation {
    constexpr uintptr_t AssetId = 0x308;
}
